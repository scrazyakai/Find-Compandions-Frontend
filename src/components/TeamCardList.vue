<template>
  ...
  >
    ...
    <van-dialog v-model="showPasswordDialog" title="请输入密码" show-cancel-button @confirm="doJoinTeam" @cancel="doJoinCancel">
...
#teamCardList :deep(.van-button.join-team-btn.van-button--primary.van-button--plain) {
  --van-button-plain-text-color: #b3d8ff !important;
  --van-button-plain-border-color: #cce5ff !important;
  --van-button-plain-background-color: #f0f7ff !important;
